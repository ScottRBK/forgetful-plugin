---
description: Configure Forgetful MCP server for Claude Code
allowed-tools: Bash, WebFetch, AskUserQuestion
---

# Forgetful Setup

Configure the Forgetful semantic memory MCP server.
...
- If no, exit with message: "Forgetful is already configured. Use `claude mcp list` to see details."
...
- Configuration is stored in `~/.claude.json` and persists across plugin updates
